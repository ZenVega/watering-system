...
#define AOUT_PIN_MOISTURE_2 35
#define AOUT_PIN_W_LEVEL_1 33
#define W_LEVEL_POWER 25
#define PUMP_1_SIGNAL 26
#define REFILL_LED 27

#define START_WATERING_TIME 10
#define END_WATERING_TIME 12

#define MIN_MOISTURE_PERCENTAGE 30
#define DONT_WATER_THRESHOLD 40
#define STOP_WATERING_MOISTURE_PERCENTAGE 30
#define MAX_WATERING_REPITITIONS 4
#define SECONDS_WATERING 4
#define MINUTES_SLEEP_AFTER_WATERING 10
#define MINUTES_SLEEP_EMPTY_TANK 60
#define THRESHOLD_WATER_LEVEL_EMPTY 700
#define THRESHOLD_WATER_LEVEL_LOW 1000
